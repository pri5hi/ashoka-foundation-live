...
const testimonials = [
  ...
  { quote: "I've seen Creative Ashoka Foundation work quietly but tirelessly for both people and animals. Their efforts through Udaan and other initiatives prove that real change begins with compassion and action. Truly a foundation that inspires hope.", name: "Rohan Mehta", role: "Volunteer, Delhi" },
